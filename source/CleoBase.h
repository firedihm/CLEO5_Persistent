...
class CCleoInstance
{
    ...
    private:
        ...
        static void __cdecl OnScmInit1();
        static void __cdecl OnScmInit2();
        static void __cdecl OnScmInit3();
        ...
        static void __cdecl OnDebugDisplayTextBuffer_Idle();
        static void __cdecl OnDebugDisplayTextBuffer_Frontend();
